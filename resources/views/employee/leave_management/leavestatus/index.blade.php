    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header with-border" style="font-size: 22px; text-align: center;">My Leave Status</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                           <strong class="text-{{ $enfinc->IsForwarded == 'Y'?'success':'danger' }}"> {{ $enfinc->IsForwarded == 'Y'?'YES':'NO' }}</strong>
                                        </td>
                                        <td style="text-align: center;">
                                            <strong class="text-{{ $enfinc->IsApproved == 'Y'?'success':'danger' }}"> {{ $enfinc->IsApproved == 'Y'?'YES':'NO' }}</strong>
                                        </td>
                                    </tr>
                                    <?php $sl1++; ?>
                                    @endforeach
