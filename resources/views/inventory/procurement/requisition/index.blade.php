...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-7">
                    <h1 class="m-0 text-right">Requisition</h1>
                </div>
                <div class="col-sm-5">
    ...
    <div class="content">
        <div class="row">
                        ...
                        @foreach ($requisitions as $group)
                            <div class="accordion" id="faq">
                                ...
                                @foreach ($group as $item)
                                    <div id="faq{{ $item->requisition_date }}" class="collapse" aria-labelledby="faqhead2"
                                        data-parent="#faq">
            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title text-center w-75">Items Requisition</h3>
                    </div>
                    <div class="card-body" style="min-height:400px; max-height:500px; overflow-y:auto;">
                        <table class="table table-striped table-bordered">
                            ...
                            {!! Form::open([
                                'action' => [
                                    '\App\Http\Controllers\Inventory\Procurement\RequisitionController@store',
                                    'method' => 'Post',
                                    'form' => '1',
                                ],
                            ]) !!}
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div class="controls">
                                                {!! Form::text('requisition_date', $inputdate, [
                                                    'required',
                                                    'class' => 'form-control datepicker',
                                                    'id' => 'requisition_date',
                                                    'placeholder' => 'Requisition Date',
                                                    'value' => Input::old('requisition_date'),
                                                ]) !!}
                                            </div>
                                        </div>
                                    </td>
