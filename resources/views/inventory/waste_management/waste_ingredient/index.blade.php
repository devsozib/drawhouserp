@extends('layout.app')
@section('title', 'Inventory | Waste Ingredient')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="javascript::void(0)">Waste Management</a></li>
                        <li class="breadcrumb-item"><a href="{!! url('inventory/waste_management/waste_ingredient') !!}">Waste Ingredient</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title text-center w-75">Waste Ingredient List</h3>
                        @if ($create)
                                ...
                                <div class="modal-dialog modal-lg ">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Add Waste Ingredient</h4>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                        <div class="modal-body">                                       
                                            {!! Form::open([
                                                'action' => ['\App\Http\Controllers\Inventory\WasteManagement\WasteIngredientController@store', 'method' => 'Post'],
                                            ]) !!}
                                            ...
                                            <div class="row" style="padding-left: 0px; padding-right: 0px;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="ing_id">Ingredient Name</label>
                                                        <div class="controls">
                                                            {!! Form::select('ing_id',[], null, [
                                                                'required',
                                                                'class' => 'form-control select2bs4',
                                                                'id' => 'ing_id',                                                            
                                                                'value' => Input::old('ing_id'),
                                                            ]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($waste_ings as $waste_ing)
                                                <tr>
                                                    ...
                                                    <td>{!! $waste_ing->ing_name !!} ({!! $waste_ing->unit_name !!})</td>
                                                    ...
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog modal-md">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        Ingredient:
                                                                        <strong
                                                                            style="color: darkorange">{{ $waste_ing->ing_name }}</strong>
                                                                        ?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        {!! Form::open(['url' => 'inventory/waste_management/waste_ingredient/' . $waste_ing->id]) !!}
                                                        ...
                                                        <div class="modal fade" id="edit-modal{!! $waste_ing->id !!}"
                                                            ...
                                                            <div class="modal-dialog modal-lg ">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">Edit Waste Ingredient,
                                                                            Name: {!! $waste_ing->ing_id !!}</h4>
                                                                        <button type="button" class="close"
                                                                            data-dismiss="modal" aria-label="Close"><span
                                                                                aria-hidden="true">&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row"
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label for="ing_id">Ingredient
                                                                                        Name</label>
                                                                                    <div class="controls">
                                                                                        {!! Form::select('ing_id', [], $waste_ing->ing_id, [
                                                                                            'required',
                                                                                            'class' => 'form-control select2bs4',
                                                                                            'id' => 'ing_id'.$waste_ing->id,
                                                                                            'placeholder' => 'Select One',
                                                                                            'value' => Input::old('ing_id'),
                                                                                        ]) !!}
                                                                                    </div>
                                                                ...
                                                                if (company_id) {
                                                                    $.ajax({
                                                                        ...
                                                                        success:function(data) {
                                                                            if (data) {
                                                                                $("#ing_id{{$waste_ing->id}}").empty();
                                                                                $.each(data, function(key,value) {
                                                                                    if (value.id == '{{$waste_ing->ing_id}}') {
                                                                                        $("#ing_id{{$waste_ing->id}}").append('<option value="'+value.id+'" selected>'+value.name+" ("+value.unit_name+")"+'</option>');
                                                                                    } else {
                                                                                        $("#ing_id{{$waste_ing->id}}").append('<option value="'+value.id+'">'+value.name+" ("+value.unit_name+")"+'</option>');
                                                                                    }
                                                                                });
                                                                            } else {
                                                                               $("#ing_id{{$waste_ing->id}}").empty();
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if (data) {
                            $("#ing_id").empty();
                            $.each(data, function(key,value) {
                                $("#ing_id").append('<option value="'+value.id+'">'+value.name+" ("+value.unit_name+")"+'</option>');
                            });
                        } else {
                           $("#ing_id").empty();
                        }
