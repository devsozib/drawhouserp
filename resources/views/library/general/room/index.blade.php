            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('library/general/room') !!}">Room</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h3 class="card-title text-center w-75">Room List</h3>
                            @if ($create)
                                    ...
                                    <div class="modal-dialog modal-lg ">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                {!! Form::open([
                                                    'action' => ['\App\Http\Controllers\Library\General\RoomController@store'],
                                                    'method' => 'POST'
                                                ]) !!}
                                                ...
                                                <div class="row" style="padding-left: 0px; padding-right: 0px;">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                {!! Form::number('room_no', null, [
                                                                    'required',
                                                                    'class' => 'form-control',
                                                                    'id' => 'room_no',
                                                                    'maxlength' => '10',
                                                                    'placeholder' => 'Room number',
                                                                    'value' => Input::old('room_no'),
                                                                ]) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <td>
                                                                ...
                                                                <div class="modal-dialog modal-md">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <strong
                                                                                style="color: darkorange">{{ $user->room_no }}</strong>
                                                                            ?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            {!! Form::open(['url' => 'library/general/room/' . $user->id]) !!}
                                                            ...
                                                            <div class="modal fade"
                                                                ...
                                                                <div class="modal-dialog modal-lg ">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Edit Room,
                                                                                Room: {!! $user->room_no !!}</h4>
                                                                            <button type="button" class="close"
                                                                                data-dismiss="modal"
                                                                                aria-label="Close"><span
                                                                                    aria-hidden="true">&times;</span></button>
                                                                            ...
                                                                            <div class="row"
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="controls">
                                                                                            {!! Form::number('room_no', $user->room_no, [
                                                                                                'required',
                                                                                                'class' => 'form-control',
                                                                                                'id' => 'room_no',
                                                                                                'maxlength' => '100',
