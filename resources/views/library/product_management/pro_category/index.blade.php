...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><small>Product Category</small></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('library/product_management/product_category') !!}">Product Category</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title text-center w-75">Product Category List</h3>
                        @if ($create)
                                ...
                                <div class="modal-dialog modal-lg ">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form
                                                action="{{ action('\App\Http\Controllers\Library\ProductManagement\ProductCategoryController@store') }}"
                                                method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="pro_cat_id" id="" class="form-control select2Txt">
                                                                <option value="" selected disabled hidden>--Select One--</option>
                                                                @foreach ($productCatNotForYou as $item)
                                                        ...
                                                        <div class="modal fade" id="delete-modal{!! $item->id !!}"
                                                            ...
                                                            <div class="modal-dialog modal-md">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ url('library/product_management/product_category', $item->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('delete')
