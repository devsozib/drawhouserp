...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><small>Units</small></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('library/general/product_management/unit') !!}">Units</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title text-center w-75">Unit Lists</h3>
                        @if ($create)
                                ...
                                <div class="modal-dialog modal-lg ">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form
                                                action="{{ action('\App\Http\Controllers\Library\ProductManagement\UnitController@store') }}"
                                                method="post">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="delete-modal{!! $item->id !!}"
                                                            ...
                                                            <div class="modal-dialog modal-md">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ url('library/product_management/unit', $item->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('delete')
                                                                            <button type="submit"
                                                        ...
                                                        <div class="modal fade" id="edit-modal{!! $item->id !!}"
                                                            ...
                                                            <div class="modal-dialog modal-lg ">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">Edit Unit, Name:
                                                                            {!! $item->name !!}</h4>
                                                                        <button type="button" class="close"
                                                                            data-dismiss="modal" aria-label="Close"><span
                                                                                aria-hidden="true">&times;</span></button>
