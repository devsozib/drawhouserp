...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Ingredient</small></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="javascript::void(0)">Edit Ingredient</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title text-center w-75">Edit Ingredient</h3>
                        @if ($create)
                    ...
                    <div class="card-body" style="overflow-x: scroll;">
                        <div class="row">
                            <div class="col-lg-12">
                                <form
                                    action="{{ action('\App\Http\Controllers\Library\ProductManagement\IngredientController@update', $ingredient->id) }}"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="Name">Ingredient Default Weight Unit</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="Name">Select A Branch for the Ingredient</label>
                                                        <select name="company_id" id="company_id"
                                                            ...
                                                            @foreach ($companies as $company)
                                                                <option
                                                                    {{ $ingredient->company_id == $company->id ? 'selected' : '' }}
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="in_category_select" id="in_category_select"
                                                            ...
                                                            <option
                                                                {{ $ingredient->category_id == $item->id ? 'selected' : '' }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="in_sub_category_select" id="in_sub_category_select"
                                                            ...
                                                            @foreach ($subCategories as $item)
                                                                <option                                                                  
                                                                    {{ $ingredient->subcategory_id == $item->id ? 'selected' : '' }}
                                                                    value="{{ $item->id }}">{{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <div class="controls">
                                                            <select name="status" id="" class="form-control">
                                                                <option value="" selected disabled hidden>--Select
                                                                    One--</option>
                                                                <option {{ $ingredient->status == 1 ? 'selected' : '' }}
                                                                    value="1">Active</option>
                                                                <option {{ $ingredient->status == 0 ? 'selected' : '' }}
                                                ...
                                                <div class="col-md-3" id="image_sec">
                                                    <div class="form-group">
                                                        ...
                                                        <img style="width:200px; border-radius:10px" id="image-preview"
                                                            src="{{ url('public/ingredient_images/', $ingredient->image) }}"
                                                            alt="Preview">
                                                    </div>
                                                </div>
                                            </div>
