...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><small>Ingredient Lists</small></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('library/product_management/ingredient') !!}">Ingredient Lists</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title text-center w-75">Ingredient List</h3>
                        @if ($create)
                            <div class="float-right"><a
                                    href="{{ action('\App\Http\Controllers\Library\ProductManagement\IngredientController@create') }}"
                                            ...
                                            @foreach ($ingredients as $item)
                                                <tr>
                                                    ...
                                                    <td><img style="width:100px"
                                                            src="{{ $item->image != null? url('public/ingredient_images/', $item->image):'https://t3.ftcdn.net/jpg/02/48/42/64/240_F_248426448_NVKLywWqArG2ADUxDq6QprtIzsF82dMF.jpg' }}"
                                                            alt=""></td>
                                                    <td>{!! $item->name !!}</td>
                                                            ...
                                                            <div class="modal-dialog modal-md">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ action('\App\Http\Controllers\Library\ProductManagement\IngredientController@destroy', $item->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('delete')
                                                                            <button type="submit"
