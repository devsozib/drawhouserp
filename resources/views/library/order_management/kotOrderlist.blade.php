                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width:{{ 100/$col }}%;">
                                <input onclick="cookingStart({{ $order->unique_order_id }})" type="checkbox" class=" btn btn-sm btn-primary  m-0 p-1" style="height: 30px; width: 30px;" {{  $order->cooking_status == "1" ? 'disabled checked' : '' }} >
                            </td>
                            <td style="width:{{ 100/$col }}%;">
                                <input onclick="cookingEnd({{ $order->unique_order_id }})" type="checkbox" class=" {{  $order->cooking_status != "1" ? 'd-none' : '' }} btn btn-sm btn-primary  m-0 p-1" style="height: 30px; width: 30px;">
                            </td>
                            <td style="width:{{ 100/$col }}%;">
