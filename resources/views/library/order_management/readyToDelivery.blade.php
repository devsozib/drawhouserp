    ...
    <div class="content-header" style="height: 100vh;">
                        ...
                        <table class="table" style="">
                            <thead>
                              <tr>
                                ...
                                <th scope="col" style="width:{{ 100/$col }}%;">Deliveried</th>
        ...
        <script>
            function showOrders(){
                ...
                $.get('{{ route('get_ready_to_delivery_order_by_ajax') }}', {concern:concern}, function(data){
                    // console.log(data);
                    $("#tableRow").html(data);
                });
            }

            function deliveried(uniqueOrderId){
                var flag = true;
                $.get('{{ route('delivered_by_ajax') }}', {uniqueOrderId:uniqueOrderId,flag:flag}, function(data){
                    showOrders();
                });
            }
