@extends('layout.app')
@section('title', 'HRIS | Designation')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('hris/setup/designation') !!}">Designation</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h3 class="card-title text-center w-75">Designation List</h3>
                            @if ($create)
                                    ...
                                    <div class="modal-dialog modal-lg ">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                {!! Form::open([
                                                    'action' => ['\App\Http\Controllers\HRIS\Setup\DesignationController@store', 'method' => 'Post'],
                                                ]) !!}
                                                        ...
                                                        <td>
                                                                ...
                                                                <div class="modal-dialog modal-md">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <strong
                                                                                style="color: darkorange">{{ $user->Designation }}</strong>
                                                                            ?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            {!! Form::open(['url' => 'hris/setup/designation/' . $user->id]) !!}
                                                            ...
                                                            <div class="modal fade"
                                                                ...
                                                                <div class="modal-dialog modal-lg ">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Edit Designation,
                                                                                Designation: {!! $user->Designation !!}</h4>
                                                                            <button type="button" class="close"
                                                                                data-dismiss="modal"
                                                                                aria-label="Close"><span
                                                                                    aria-hidden="true">&times;</span></button>
