            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('hris/setup/department') !!}">Department</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <h3 class="card-title text-center w-75">Department List</h3>
                            @if ($create)
                                                                ...
                                                                <div class="modal-dialog modal-md">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <strong
                                                                                style="color: darkorange">{{ $user->Department }}</strong>
                                                                            ?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            {!! Form::open(['url' => 'hris/setup/department/' . $user->id]) !!}
