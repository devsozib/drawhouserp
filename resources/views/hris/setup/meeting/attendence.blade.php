        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="javascript::void(0)">Meeting Arttendence Participant</a></li>
...
<div class="content">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <h3 class="text-center">Attendance for <span class="text-primary">{{ $meeting->m_name }}</span></h3>
                <div class="row">
                    <div class="col-md-8 m-auto">
                        <form id="issueForm" action="{{ route('assign.training') }}" method="post">
                            @csrf
                            <input type="hidden" value="{{ $meeting->id }}" name="training_id">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="form-check form-switch">
                                            <input class="form-check-input" onchange="attendence('{{ $item->meeting_id }}','{{ $item->EmployeeID }}')" type="checkbox"  id="flexSwitchCheckChecked" {{ $item->present=='1'?'checked':'' }}>
...
<script>
    function attendence(meeting_id, emp_id) {
        $.ajax({
            type: "GET",
            url: "{{ url('meetingattendence') }}",
            data: {
