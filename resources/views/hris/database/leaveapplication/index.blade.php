...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('hris/database/leaveapplication') !!}">Leave Application</a></li>
    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::open([
                    'action' => ['\App\Http\Controllers\HRIS\Database\LeaveApplicationController@store', 'method' => 'Post'],
                ]) !!}
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
