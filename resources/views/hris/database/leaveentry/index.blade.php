@extends('layout.app')
@section('title', 'HRIS | Leave Entry')
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="text-align: right;">Leave Entry</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('hris/database/leaveentry') !!}">Leave Entry</a></li>
    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                {!! Form::open(array('action' => array('\App\Http\Controllers\HRIS\Database\LeaveEntryController@store', 'method' => 'Post'))) !!}
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header with-border" style="font-size: 16px;">Input Parameters For Leave Entry Form</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-5">
