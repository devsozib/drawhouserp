                                        ...
                                        <tbody>
                                            @foreach ($applicants as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p> {{ $item->status == 0 ? 'Pending' : ($item->status == 1 ? 'Processing' : ($item->status == 2 ? 'Selected' : ($item->status == 3 ? 'Rejected' : 'Nothing'))) }}
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" target="_blank"
                                                            href="{!! URL('hris/applicant/new-applicant', [$item->emp_id]) !!}?applicant=show">See
                                                            Details</a>|<a class="btn btn-sm btn-primary" target="_blank"
                                                            href="{{ route('interview.show', $item->emp_id) }}">Take
                                                            Interview</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" target="_blank"
                                                            href="{!! URL('hris/applicant/new-applicant', [$item->emp_id]) !!}?applicant=show">See
                                                            Details</a>|<a class="btn btn-sm btn-primary" target="_blank"
                                                            href="{{ route('interviews.show', $item->emp_id) }}">Take
                                                            Interview</a>
                                                    </td>
                                                </tr>
                                            @endforeach
