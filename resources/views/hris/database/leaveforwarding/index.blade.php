    ...
    <div class="row" style="padding-left: 5px; padding-right: 5px;">
        <div class="col-lg-12" style="padding-left: 5px; padding-right: 5px;">
            ...
            <div class="col-lg-9" style="padding-left: 5px; padding-right: 5px;">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="font-size: 16px;">One Shot Leave Forwarding</div>
                    {!! Form::open(array('action' => array('\App\Http\Controllers\HR\Database\LeaveForwardingController@store', 'method' => 'Post'))) !!}
                    ...
                    <div class="panel-footer">
                        ...
                        @if(Sentinel::inRole('managing-director') || Sentinel::inRole('superadmin') || Sentinel::getUser()->id==21)
                            <button type="submit" id="delete_all" name="discard" class="btn" style="color:red;">Discard</button> &nbsp;&nbsp;
