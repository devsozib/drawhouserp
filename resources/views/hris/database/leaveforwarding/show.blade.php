...
<section class="content-header">
    <h1 style="text-align: center;">Leave Forwarding</h1>
    <ol class="breadcrumb">
        <li><a href="{{ url('/hr') }}">HRIS</a></li>
        <li><a href="{{ url('hr/database') }}">Database</a></li>
        <li><a href="{{ url('hr/database/leaveforwarding') }}">Leave Forwarding</a></li>
        ...
        <div class="col-lg-12" style="padding-left: 5px; padding-right: 5px;">
            ...
            <div class="col-lg-3" style="padding-left: 5px; padding-right: 5px;">
                <div class="panel panel-default">
                    <div class="panel-heading" style="font-size: 16px;">Leave Forwarding List</div>
                                                            ...
                                                            <ul class="nav collapse in" id="{!! $orderr->EmployeeID !!}" role="menu" aria-labelledby="btn-1" style="margin-left: 1px;">
                                                                @foreach( $formid11 as $fabricbooking )
                                                                    @if($orderr->EmployeeID == $fabricbooking->EmployeeID)
                                                                        ...
                                                                        <li style="line-height: 0.7em;"><a style="margin-left: -10px; background-color: lightgray;" href="{!! URL::route('hr.database.leaveforwarding.show', array($fabricbooking->id)) !!}">{!! $fabricbooking->FormID !!} : {!! \Carbon\Carbon::parse($fabricbooking->ApplicationDate)->format('d-m-Y g:i A') !!}</a></li>
                                                                        @else
                                                                        <li style="line-height: 0.7em;"><a style="margin-left: -10px;" href="{!! URL::route('hr.database.leaveforwarding.show', array($fabricbooking->id)) !!}">{!! $fabricbooking->FormID !!} : {!! \Carbon\Carbon::parse($fabricbooking->ApplicationDate)->format('d-m-Y g:i A') !!}</a></li>
                                                                        @endif
                                                                    @endif
                                                                @endforeach
                                                            </ul>
            ...
            {!! Form::open(array('action' => array('\App\Http\Controllers\HR\Database\LeaveForwardingController@update', $uniqueleave->id), 'method' => 'PATCH')) !!}
            <div class="col-lg-9" style="padding-left: 5px; padding-right: 5px;">
                <div class="panel panel-default">
                    <div class="panel-heading" style="font-size: 16px;">
                        Input Parameters For Leave Forwarding
                        <a href="{!! URL::route('hr.database.leaveforwarding.index') !!}" class="btn btn-primary pull-right" style="margin-top: -5px;"> <span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back </a>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="control-group">
                                                    <div class="controls">
                                                        {!! Form::text('CreatedBy2', GetUserDetails($uniqueleave->CreatedBy)->Name, array('disabled', 'class'=>'form-control', 'id' => 'CreatedBy2')) !!}
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="panel-footer" style="margin-top: -20px;">
                        {!! Form::text('ForwardedDate', $inputDate, array('class'=>'form-control hidden', 'id' => 'ForwardedDate', 'maxlength'=>'10')) !!}                                           
                        @foreach($uniquepermissions as $uniquepermission)
                            @if($uniquepermission->Slug=='view')
                            <button type="submit" name="discard" value="Discard" class="btn btn-warning">Discard</button>&nbsp;&nbsp;&nbsp;&nbsp;
                            {!! Form::submit('Forward', array('class' => 'btn btn-success  pull-right')) !!}
                            @endif
                        @endforeach
                    </div>
                </div>
