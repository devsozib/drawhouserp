...
@section('content')
    <style>
      /* Place this inside your CSS file */
      .rating {
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{!! url('employee/dashboard') !!}">HRIS</a></li>
    ...
    <div class="container">
        <div class="card">
            <h5 class="m-0 p-3 text-center text-primary">
                Performance history of {{ $emp->Name }}
            </h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                @forelse ($performanceDetails as $performance)
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p>Evaluate By: {{ getEmpName($performance['created_by'])->Name  }} </p>
