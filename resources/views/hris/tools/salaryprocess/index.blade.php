@extends('layout.app')
@section('title', 'HRIS | Salary Process')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('hris/tools/salaryprocess') !!}">Salary Process</a></li>
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header with-border" style="font-size: 22px; text-align: center;">Salary Process</div>
                    {!! Form::open(array('action' => array('\App\Http\Controllers\HRIS\Tools\SalaryProcessController@store', 'method' => 'Post'))) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">             
                                    <div class="controls">  
                                        {{ Form::radio('title', 1, true, array('id'=>'title1','class'=>'titles')) }} <label for="title1">Process Salary Sheet</label> <br>
                                        {{ Form::radio('title', 2, false, array('id'=>'title2','class'=>'titles')) }} <label for="title2">Undo/Revert Salary Processing</label> <br>
                                        @if (Sentinel::inRole('superadmin'))
                                        {{ Form::radio('title', 3, false, array('id'=>'title3','class'=>'titles')) }} <label for="title3">Confirm Salary Process</label>
                                        @endif                                       
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card">
                        <div class="card-header with-border text-center">
                            <h4>Salary Process List</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ action('\App\Http\Controllers\HRIS\Tools\SalaryProcessController@index') }}" method="get">
                                <input type="hidden" name="displaySP" value="1">
                                <div class="input-group">                                                               
                                    <input type="text" name="year_month" placeholder="Pick Year Month" class="form-control year-and-month" id="year_month">
