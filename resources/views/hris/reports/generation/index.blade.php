@extends('layout.app')
@section('title', 'HRIS | Auto Generaion')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{!! url('hris/reports/autogeneration') !!}">Auto Generaion</a></li>
    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    {!! Form::open(array('action' => '\App\Http\Controllers\HRIS\Reports\AutoGenerationController@preview')) !!}
                    <div class="card-header with-border" style="font-size: 22px; text-align: center">Auto Generation Reports</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
                                    ...
                                    <div class="controls" style="max-height: 350px; min-height: 350px; overflow-y: auto;">
                                        {{ Form::radio('title', 1, true, array('id'=>'title1','class'=>'titles')) }} <label for="title1">Employee-wise Job Card</label> <br>
                                        {{ Form::radio('title', 2, false, array('id'=>'title2','class'=>'titles')) }} <label for="title2">Department-wise Attendace</label> <br>
                                        {{ Form::radio('title', 3, false, array('id'=>'title3','class'=>'titles')) }} <label for="title3">Department-wise Absence</label> <br>
                                        {{ Form::radio('title', 4, false, array('id'=>'title4','class'=>'titles')) }} <label for="title4">Employee-wise Punch</label> <br>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="control-group {!! $errors->has('StartDate') ? 'has-error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::text('StartDate', \Carbon\Carbon::parse($inputDate)->startOfMonth()->format('Y-m-d'), array('class'=>'form-control StartDate', 'id' => 'StartDate', 'maxlength'=>'10', 'placeholder'=>'YYYY-MM-DD', 'value'=>Input::old('StartDate'))) !!}
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <script type="text/javascript">
        ...
        function titleValidation(radval){
            if(radval==1 || radval==2 || radval==3 || radval==4) {
