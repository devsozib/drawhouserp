...
class AutoGenerationController extends Controller
{
    public function index()
    {
        if (getAccess('view')) {
            ...
            return view('hris.reports.generation.index', compact('deptlist', 'desglist', 'categorylist'));
        } else {
                ...
                if ($title == 1) {
                    ...
                    if ($validation->fails()) {
                        ...
                        if (count($empids) > 0) {
                            ...
                            if ($viewmode == 1) {
                                return view('hris.reports.generation.preview', $parameter);
                            } elseif ($viewmode == 2) {
                                $pdf = PDF::loadView('hris.reports.generation.jobcard', $parameter)->setPaper('A4', 'portrait');
